...
- The cpc-style DevBench tool alio.control: state, every switch, look, describe, spawn, simulate (pick/smash/spell/fire/shock/frost/thaw), save, reload, deactivate.
